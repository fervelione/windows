...
var modals = function modals() {
  function bindModal(buttonSelector, modalSelector, closeSelector) {
    var open = document.querySelectorAll(buttonSelector),
  ...
  function showModalOnTime(selector) {
    setTimeout(function () {
  ...
  bindModal('.phone_link', '.popup', '.popup .popup_close'); //showModalOnTime('.popup');
};
...
var tabs = function tabs(parentSelector, tabSelector, contentSelector, active) {
